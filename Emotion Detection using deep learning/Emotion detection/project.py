"""
Created on Fri Jun 10 00:53:50 2022
...
print(cv2_base_dir)
face_haar= os.path.join(cv2_base_dir, 'data/haarcascade_frontalface_default.xml')
face_haar_cascade = cv2.CascadeClassifier(face_haar)
